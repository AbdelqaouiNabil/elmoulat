                                        ...
                                        @if ($comptes->count() > 0)
                                            ...
                                            @foreach ($comptes as $compte)
                                                <tr>
                                                    <td>
                                                        <div class="form-check">
                                                            <input type="checkbox" wire:model="selectedcompte"
                                                                value="{{ $compte->id }}">
                                                    ...
                                                    <td>
                                                        <ul class="orderDatatable_actions mb-0 d-flex">
                                                            ...
                                                            <li><a href="#" class="remove" data-toggle="modal"
                                                                    ...
                                                                    wire:click='editcompte({{ $compte->id }})'><i
                                                                        class="fa-regular fa-pen-to-square"></i></a>
                                                            </li>
                                                            <li><a href="#" class="remove" data-toggle="modal"
                                                                    data-target="#modal-info-delete"
                                                                    wire:click='deletecompte({{ $compte->id }})'
                                                                    style="color: red;"><i
                                ...
                                <nav class="atbd-page ">
                                    <ul class="atbd-pagination d-flex">
                                        <li class="atbd-pagination__item">
                                            {{-- {{ $compte->links('vendor.livewire.bootstrap') }} --}}
                                        </li>
                                        <li class="atbd-pagination__item">
                                            <div class="paging-option">
                                                <select wire:model="comptepage" name="page-number"
                            ...
                            <div class="form-basic">
                                ...
                                <div class="form-group mb-25">
                                    ...
                                    <div class="form-group mb-25">
                                        ...
                                        <select name="compte_id" wire:model.defer='bankID' id="select-size-1"
                                            class="form-control  form-control-lg">
                                            <option value="" selected>select an option</option>
                                            @foreach ($comptes as $compte)
                                                <option value="{{ $compte->bank->id }}">{{ $compte->bank->nom }}</option>
                                            @endforeach
