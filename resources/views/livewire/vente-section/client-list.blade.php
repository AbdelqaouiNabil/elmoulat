                                ...
                                <table class="table mb-0 table-borderless border-0">
                                    <thead>
                                        <tr class="userDatatable-header">
                                            ...
                                            <th>
                                                <span class="userDatatable-title">CIN (PDF)</span>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($clients as $client)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="orderDatatable-title">
                                                        <a href=" {{ Storage::disk('local')->url($client->cin) }}"
                    ...
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" wire:submit.prevent="saveData()">
                            <div class="form-basic">
                                ...
                                <div class="form-group mb-25">
                                    <label class="required">Nom et Prenom</label>
                                ...
                                <div class="form-group mb-25">
                                    <label class="required">CIN (PDF)</label>
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content modal-bg-white ">
                <div class="modal-header">
                    ...
                    <h6 class="modal-title">Modifier Client</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span data-feather="x"></span></button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-body">
                    <div class="modal-info-body d-flex">
                        ...
                        <div class="modal-info-text">
                            <h6>Voulez-vous supprimer ce client</h6>
                        </div>
        ...
        <div class="modal-dialog modal-sm modal-info" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-outlined btn-sm"
                        data-dismiss="modal">annuler</button>
                    <button type="button" wire:click.prevent='deletecheckedclient()'
                        class="btn btn-success btn-outlined btn-sm" data-dismiss="modal">supprimer</button>
