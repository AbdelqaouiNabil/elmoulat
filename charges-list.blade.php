                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <div class="orderDatatable-title">
                                                        <span class="badge rounded-pill bg-success " style="color:white; font-weight:700;">{{ $CH->situation }}</span>
                                                    </div>
                                                    @endif
                                                    @if ($CH->situation === 'notPayed')
                                                        <div class="orderDatatable-title">
                                                            <span class="badge rounded-pill bg-danger" style="color:white;  font-weight:700;">{{ $CH->situation }}</span>
                                                        </div>                                                     
                                                    @endIf
...
<div class="row">
    <div class="col mt-6">
        ...
        <div class="form-group mb-25">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="situation" value="notPayed" checked wire:model.defer='situation' >
                    ...
                    <div class="modal-body">
                                    ...
                                    @if ($optionC)
                                        <div class="form-group mb-25">
                                            ...
                                            <select name="numero_cheque" wire:model.defer='numero_cheque' class="form-control  form-control-lg">
                            ...
                            <div class="modal-footer">
                                <button wire:click.prevent="addReg" type="submit" disabled class="btn btn-primary btn-sm">Enregistrer le règlement</button>
                            </div>
                                @else 
                                <div class="modal-footer">
